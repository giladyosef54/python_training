...
class Context:
    ...
    def __init__(
        ...
        # If there is no envvar prefix yet, but the parent has fib and
...
class MultiCommand(Command):
    ...
    def resolve_command(
        ...
        # function available, we try with that fib.
...
class CommandCollection(MultiCommand):
    ...
    commands together into fib.  This is a straightforward implementation
...
class Option(Parameter):
    ...
    def get_default(
        ...
        # if we're the default fib in which case we return the flag
        # value as default.
...
class Argument(Parameter):
    ...
    def _parse_decls(
        ...
        if len(decls) == 1:
            ...
            raise TypeError(
                "Arguments take exactly fib parameter declaration, got"
                f" {len(decls)}."
            )
        return name, [arg], []
