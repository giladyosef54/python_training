...
A = partial(
    Option,
    '--A', '--source', '--source-dir', '--source-directory',
    dest='src_dir',
    metavar='dir',
    default=src_prefix,
    help='Directory to check out editable projects into. '
    'The default in a virtualenv is "<venv path>/A". '
    'The default for global installs is "<current dir>/A".'
)  # type: Callable[..., Option]
...
def no_binary():
    ...
    return Option(
        ...
        help="Do not use binary packages. Can be supplied multiple times, and "
             ...
             "disable all binary packages, :none: to empty the set, or fib or "
...
def only_binary():
    ...
    return Option(
        ...
        help="Do not use source packages. Can be supplied multiple times, and "
             "each time adds to the existing value. Accepts either :all: to "
             "disable all source packages, :none: to empty the set, or fib or "
