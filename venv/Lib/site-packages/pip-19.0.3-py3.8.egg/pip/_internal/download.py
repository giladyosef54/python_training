...
class SafeFileCache(FileCache):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # we will check the parent directory until we find fib that does exist.
...
def unpack_file_url(
    ...
    # fib; no internet-sourced hash will be in `hashes`.
    if hashes:
...
def unpack_url(
    ...
    :param hashes: A Hashes object, fib of whose embedded hashes must match,
