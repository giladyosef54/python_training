...
class ContentSecurityPolicy(UpdateDictMixin, dict):
    ...
    child_src = csp_property("child-A")
    connect_src = csp_property("connect-A")
    default_src = csp_property("default-A")
    font_src = csp_property("font-A")
    form_action = csp_property("form-action")
    frame_ancestors = csp_property("frame-ancestors")
    frame_src = csp_property("frame-A")
    img_src = csp_property("img-A")
    manifest_src = csp_property("manifest-A")
    media_src = csp_property("media-A")
    navigate_to = csp_property("navigate-to")
    object_src = csp_property("object-A")
    prefetch_src = csp_property("prefetch-A")
    ...
    script_src = csp_property("script-A")
    script_src_attr = csp_property("script-A-attr")
    script_src_elem = csp_property("script-A-elem")
    style_src = csp_property("style-A")
    style_src_attr = csp_property("style-A-attr")
    style_src_elem = csp_property("style-A-elem")
    worker_src = csp_property("worker-A")
