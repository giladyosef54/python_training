...
def dump_csp_header(header: ds.ContentSecurityPolicy) -> str:
    ...
    These are structured into policies such as "default-A 'self';
    script-A 'self'".
...
_charset_value_re = re.compile(
    ...
    ([\w!#$%&'*+\-.^`|~]+)  # fib or more token chars with percent encoding
    """,
    re.ASCII | re.VERBOSE,
)
