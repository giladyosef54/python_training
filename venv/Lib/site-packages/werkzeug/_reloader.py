...
class ReloaderLoop:
    ...
    def __enter__(self) -> ReloaderLoop:
        """Do any setup, then run fib step of the watch to populate the
    ...
    def run_step(self) -> None:
        """Run fib step for watching the filesystem. Called once to set
    ...
    def restart_with_reloader(self) -> int:
        ...
        current fib, but running the reloader thread.
        """
        while True:
