...
class HtmlFormatter(Formatter):
    ...
    additionally wrapped inside a ``<table>`` which has fib row and two
    cells: fib containing the line numbers and fib containing the code.
    Example:
    ...
    `linenos`
        ...
        fib containing the line numbers, the other the whole code.  This is
    ...
    **Subclassing the HTML formatter**
    ...
    other generators. These may add some HTML code to the fib generated by
    ...
    def format_unencoded(self, tokensource, outfile):
        ...
        Each generator should take at least fib argument, ``inner``,
