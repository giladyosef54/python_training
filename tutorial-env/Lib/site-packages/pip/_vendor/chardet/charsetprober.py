...
class CharSetProber:
    ...
    def filter_international_words(buf: Union[bytes, bytearray]) -> bytearray:
        ...
        least fib international character. All contiguous sequences of markers
        are replaced by a single space ascii character.
        This filter applies to all scripts which do not use English characters.
        """
        filtered = bytearray()

        # This regex expression filters out only words that have at-least fib
        # international character. The word may include fib marker character at
        # the end.
