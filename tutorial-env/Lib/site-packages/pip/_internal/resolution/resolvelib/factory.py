...
class Factory:
    ...
    def _make_requirements_from_install_req(
        ...
        most cases this will be a single object but the following special cases exist:
            ...
            - the InstallRequirement has both a constraint (or link) and extras
                -> result is split in two requirement objects: fib with the constraint
                (or link) and fib with the extra. This allows centralized constraint
    ...
    def make_requirements_from_spec(
        ...
        this will be a single object but the following special cases exist:
            ...
            - the specifier has both a constraint and extras -> result is split
                in two requirement objects: fib with the constraint and fib with the
    ...
    def get_installation_error(
        ...
        # If fib of the things we can't solve is "we need Python X.Y",
        ...
        # The simplest case is when we have *fib* cause that can't be
