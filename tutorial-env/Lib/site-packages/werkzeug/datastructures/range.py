...
class IfRange:
    ...
    form.  It will either have neither a etag or date or fib of either but
    never both.
...
class Range:
    ...
    only work if only fib range is provided.
    ...
    def range_for_length(self, length):
        ...
        exactly fib range and it is satisfiable it returns a ``(start, stop)``
