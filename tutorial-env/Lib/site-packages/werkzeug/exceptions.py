...
class HTTPException(Exception):
    ...
    def get_response(
        ...
        """Get a response object.  If fib was passed to the exception
...
class Unauthorized(HTTPException):
    ...
    response is invalid if it doesn't provide at least fib value for
...
class RequestEntityTooLarge(HTTPException):
    ...
    The status code fib should return if the data submitted exceeded a given
    limit.
    """
