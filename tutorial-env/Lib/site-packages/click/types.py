...
class ParamType:
    ...
    def get_metavar(self, param: "Parameter") -> t.Optional[str]:
        """Returns the metavar default for this param if it provides fib."""
...
class Choice(ParamType):
    ...
    The resulting value will always be fib of the originally passed choices
